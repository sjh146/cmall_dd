...
VALUES
  ...
  -- 190: 월 $5 올액세스 구독 (M6 — 전 서비스 무제한, billing_interval_days=30)
  (190, 212, '퀀트 트레이더 올액세스 구독', 500, 0, '', 'AI 분석', 'software',
   'subscription_bundle', '1.0.0', '', 0, '',
   '월 5 USDC — 스크리너/팩터/리포트 전 서비스 무제한 (자동 갱신)', '', '', 5000000)
