...
VALUES
  ...
  (180, 212, '스윙종목 스크리너 (analyist_dd)', 3000, 0, '', 'AI 분석', 'software',
   ...
   '전 종목 스윙 스크리닝 리포트 — ML 예측/신뢰도 (USDC 결제)', '', '', 3000000),
  (181, 212, '모델 백테스트 리포트', 2000, 0, '', 'AI 분석', 'software',
   'backtest', '1.0.0', '', 0, '',
   'ML 모델 백테스트 결과 — 신호/수익률/승률 (USDC 결제)', '', '', 2000000),
  (182, 212, '강환국 투자팩터 5종 리포트', 5000, 0, '', 'AI 분석', 'software',
   'factor_report', '1.0.0', '', 0, '',
   '강환국『하면 된다! 퀀트투자』팩터 전략 5종 결과 (USDC 결제)', '', '', 5000000)
